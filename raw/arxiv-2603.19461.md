...
## Notes
- Relevance: self-improving, self-referential AI systems
- Key themes:
  - self-improvement
  - metacognition
  - editable programs
...
## Why it matters
This source supports the computation layer of the stack. It is relevant to:
