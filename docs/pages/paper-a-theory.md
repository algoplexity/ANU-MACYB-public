# Minimal Unified Theory of Observer-Grounded Collective Intelligence

## Metadata
- Source type: theory note
- Related stream: multi-agent systems
- Status: draft
- Scope: conceptual foundations for collective intelligence, coordination, and measurement
- Dependencies: seed corpus on multi-agent systems
...
- coordinated action
- adaptive division of labor
- information integration
- robust response to perturbation
- measurable organization over time
...
- self-organization under constraints
...
- temporal persistence of organization
